...
## Диаграмма классов с детализацией бэкенда и фронтенда

Домены с методами, но без моделей и БД, фронтенд разделить на страницы (все страницы а не только 3), добавить у страниц зависимость от API.
