...
## Дополнительное задание на хвостовую

Все 9 запросов по заявкам и м-м оставить с кодогенерацией и thunk. Все запросы по услугам и пользователю переделать без использования кодогенерации и thunk, но состояния услуг и пользователя хранить в Redux как в методичке по 6ой и Лекции 10.